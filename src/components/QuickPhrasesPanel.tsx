          ...
          <div className="space-y-1">
            {filteredPhrases.length === 0 ? (
              ...
              filteredPhrases.map(phrase => (
                ...
                >
                  <div className="font-medium text-gray-900">{phrase.label}</div>
                    ...
                    <div className="bg-white">
                      {categoryPhrases.map(phrase => (
                        <button
                          ...
                          onClick={() => onSelectPhrase(phrase)}
                          disabled={disabled}
                          className="w-full text-left px-4 py-2 text-sm hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors border-t border-gray-100 first:border-t-0"
                        >
                          <div className="font-medium text-gray-800">• {phrase.label}</div>
                          <div className="text-xs text-gray-500 mt-0.5 line-clamp-2">
                            {phrase.text}
                          </div>
                        </button>
