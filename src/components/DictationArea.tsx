  ...
  return (
    <div className="bg-[#111111] rounded-lg border border-[#222222] p-4">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-lg font-semibold text-gray-100">Área de Ditação</h3>
        ...
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-blue-600 text-xl">
            🎙
          </span>
          <span className="sr-only">{isListening ? 'Parar Ditado' : 'Iniciar Ditado'}</span>
        </button>
      </div>
