...
export default function ArtigosPage() {
  ...
  useEffect(() => {
    ...
    async function carregar() {
      ...
      setAviso(null);
      try {
        // Ajuste fino do backend: pega ítens mais relevantes, janela de 120 dias
        ...
        if (!ignore) {
          ...
          if (data?.source === "fallback") setAviso("Mostrando lista alternativa (feeds indisponíveis).");
        }
      } catch {
        if (!ignore) {
  ...
  return (
    <div className="space-y-8 text-slate-900">
      ...
      {carregando && <div className="text-center text-slate-600">🔄 Carregando artigos...</div>}
